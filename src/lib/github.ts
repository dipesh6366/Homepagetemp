...
export const fetchRepositories = async (token: string) => {
  ...
  // Include personal repos, repos you collaborate on, and org repos so
  // multi-repo / org workflows aren't limited to repos you personally own.
...
export const uploadToGitHub = async (
  ...
  try {
    // 1. Resolve the branch to push to (falls back to the repo's default branch)
